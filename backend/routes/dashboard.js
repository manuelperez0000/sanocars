...
router.get('/', async (req, res) => {
  try {
    ...
    var [vehiclesSoldResult] = await db.query(
    ...
    var [vehiclesRentedResult] = await db.query(
    ...
    var [totalVehiclesResult] = await db.query(
      'SELECT COUNT(*) as count FROM vehiculos_venta WHERE status != ?',
      ['Eliminado']
    )
    ...
    var [pendingFinancingsResult] = await db.query(
